...
if __name__ == '__main__':
    ...
    text = "Hello, this is a synthesized version of John's voice, I hope that it is very impressive, I like drones, this is a much longer sentence to see how the model deals with it."
